...
ES_HOST="10.175.4.9"
ES_PORT="9200"
INDEX_NAME="fs-forms-data"

# Elasticsearch URL and index name
ES_URL="http://$ES_HOST:$ES_PORT"

SCROLL_TIME="2m" # Keep the search context alive for 2 minutes
BATCH_SIZE=100 # Fetch 1000 records per batch
