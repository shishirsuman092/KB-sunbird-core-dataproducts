error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala:
...
non-local guesses:
	 -org/apache/spark/sql/functions/FrameworkContext.
	 -org/apache/spark/sql/functions/FrameworkContext#
	 -org/apache/spark/sql/functions/FrameworkContext().
	 -org/ekstep/analytics/dashboard/DashboardUtil.FrameworkContext.
	 -org/ekstep/analytics/dashboard/DashboardUtil.FrameworkContext#
	 -org/ekstep/analytics/dashboard/DashboardUtil.FrameworkContext().
	 -org/ekstep/analytics/dashboard/DataUtil.FrameworkContext.
	 -org/ekstep/analytics/dashboard/DataUtil.FrameworkContext#
	 -org/ekstep/analytics/dashboard/DataUtil.FrameworkContext().
	 -org/ekstep/analytics/framework/FrameworkContext.
	 -org/ekstep/analytics/framework/FrameworkContext#
	 -org/ekstep/analytics/framework/FrameworkContext().
	 -org/apache/spark/sql/types/FrameworkContext.
	 -org/apache/spark/sql/types/FrameworkContext#
	 -org/apache/spark/sql/types/FrameworkContext().
	 -FrameworkContext.
	 -FrameworkContext#
	 -FrameworkContext().
	 -scala/Predef.FrameworkContext.
	 -scala/Predef.FrameworkContext#
	 -scala/Predef.FrameworkContext().
offset: 368
...
import org.ekstep.analytics.framework.FrameworkCont@@ext
