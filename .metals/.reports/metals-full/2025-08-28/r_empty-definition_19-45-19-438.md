error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala:org/ekstep/analytics/dashboard/DataUtil.userCourseProgramCompletionDataFrame().
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala
empty definition using pc, found symbol in pc: org/ekstep/analytics/dashboard/DataUtil.userCourseProgramCompletionDataFrame().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/userCourseProgramCompletionDataFrame.
	 -org/apache/spark/sql/functions/userCourseProgramCompletionDataFrame#
	 -org/apache/spark/sql/functions/userCourseProgramCompletionDataFrame().
	 -org/ekstep/analytics/dashboard/DashboardUtil.userCourseProgramCompletionDataFrame.
	 -org/ekstep/analytics/dashboard/DashboardUtil.userCourseProgramCompletionDataFrame#
	 -org/ekstep/analytics/dashboard/DashboardUtil.userCourseProgramCompletionDataFrame().
	 -org/ekstep/analytics/dashboard/DataUtil.userCourseProgramCompletionDataFrame.
	 -org/ekstep/analytics/dashboard/DataUtil.userCourseProgramCompletionDataFrame#
	 -org/ekstep/analytics/dashboard/DataUtil.userCourseProgramCompletionDataFrame().
	 -org/apache/spark/sql/types/userCourseProgramCompletionDataFrame.
	 -org/apache/spark/sql/types/userCourseProgramCompletionDataFrame#
	 -org/apache/spark/sql/types/userCourseProgramCompletionDataFrame().
	 -userCourseProgramCompletionDataFrame.
	 -userCourseProgramCompletionDataFrame#
	 -userCourseProgramCompletionDataFrame().
	 -scala/Predef.userCourseProgramCompletionDataFrame.
	 -scala/Predef.userCourseProgramCompletionDataFrame#
	 -scala/Predef.userCourseProgramCompletionDataFrame().
offset: 7225
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala
text:
```scala
...
object BlendedProgramReportModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    // get enrolment table
    val userEnrolmentDF = userCourseProgra@@mCompletionDataFrame(extraCols = Seq("courseContentStatus"))
