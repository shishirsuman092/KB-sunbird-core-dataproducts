error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/exhaust/DataExhaustModel.scala:local45
...
non-local guesses:
	 -org/apache/spark/sql/conf/cassandraUserKeyspace.
	 -org/apache/spark/sql/conf/cassandraUserKeyspace#
	 -org/apache/spark/sql/conf/cassandraUserKeyspace().
	 -org/apache/spark/sql/functions/conf/cassandraUserKeyspace.
	 -org/apache/spark/sql/functions/conf/cassandraUserKeyspace#
	 -org/apache/spark/sql/functions/conf/cassandraUserKeyspace().
	 -org/ekstep/analytics/dashboard/DashboardUtil.conf.cassandraUserKeyspace.
	 -org/ekstep/analytics/dashboard/DashboardUtil.conf.cassandraUserKeyspace#
	 -org/ekstep/analytics/dashboard/DashboardUtil.conf.cassandraUserKeyspace().
	 -org/ekstep/analytics/dashboard/DataUtil.conf.cassandraUserKeyspace.
	 -org/ekstep/analytics/dashboard/DataUtil.conf.cassandraUserKeyspace#
	 -org/ekstep/analytics/dashboard/DataUtil.conf.cassandraUserKeyspace().
	 -org/apache/spark/sql/types/conf/cassandraUserKeyspace.
	 -org/apache/spark/sql/types/conf/cassandraUserKeyspace#
	 -org/apache/spark/sql/types/conf/cassandraUserKeyspace().
	 -scala/concurrent/conf/cassandraUserKeyspace.
	 -scala/concurrent/conf/cassandraUserKeyspace#
	 -scala/concurrent/conf/cassandraUserKeyspace().
	 -scala/concurrent/duration/conf/cassandraUserKeyspace.
	 -scala/concurrent/duration/conf/cassandraUserKeyspace#
	 -scala/concurrent/duration/conf/cassandraUserKeyspace().
	 -org/ekstep/analytics/framework/conf/cassandraUserKeyspace.
	 -org/ekstep/analytics/framework/conf/cassandraUserKeyspace#
	 -org/ekstep/analytics/framework/conf/cassandraUserKeyspace().
	 -spark/implicits/conf/cassandraUserKeyspace.
	 -spark/implicits/conf/cassandraUserKeyspace#
	 -spark/implicits/conf/cassandraUserKeyspace().
	 -conf/cassandraUserKeyspace.
	 -conf/cassandraUserKeyspace#
	 -conf/cassandraUserKeyspace().
	 -scala/Predef.conf.cassandraUserKeyspace.
	 -scala/Predef.conf.cassandraUserKeyspace#
	 -scala/Predef.conf.cassandraUserKeyspace().
offset: 10139
