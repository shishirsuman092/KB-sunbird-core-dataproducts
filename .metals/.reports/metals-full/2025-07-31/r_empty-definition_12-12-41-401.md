error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/user/UserReportModel.scala:org/ekstep/analytics/dashboard/DataUtil.getOrgUserDataFrames().
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/user/UserReportModel.scala
empty definition using pc, found symbol in pc: org/ekstep/analytics/dashboard/DataUtil.getOrgUserDataFrames().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/getOrgUserDataFrames.
	 -org/apache/spark/sql/functions/getOrgUserDataFrames#
	 -org/apache/spark/sql/functions/getOrgUserDataFrames().
	 -org/ekstep/analytics/dashboard/DashboardUtil.getOrgUserDataFrames.
	 -org/ekstep/analytics/dashboard/DashboardUtil.getOrgUserDataFrames#
	 -org/ekstep/analytics/dashboard/DashboardUtil.getOrgUserDataFrames().
	 -org/ekstep/analytics/dashboard/DataUtil.getOrgUserDataFrames.
	 -org/ekstep/analytics/dashboard/DataUtil.getOrgUserDataFrames#
	 -org/ekstep/analytics/dashboard/DataUtil.getOrgUserDataFrames().
	 -getOrgUserDataFrames.
	 -getOrgUserDataFrames#
	 -getOrgUserDataFrames().
	 -scala/Predef.getOrgUserDataFrames.
	 -scala/Predef.getOrgUserDataFrames#
	 -scala/Predef.getOrgUserDataFrames().
offset: 986
...
object UserReportModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    val (orgDF, userDF, userOrgDF) = getOrgUs@@erDataFrames()
