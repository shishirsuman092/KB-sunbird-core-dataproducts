error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/TestUtil.scala:
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/TestUtil.scala
...
offset: 8476
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/TestUtil.scala
text:
```scala
...
object TestUtil extends Serializable {
  ...
  def testModelConfig(): Map[String, AnyRef] = {
    ...
    val modelParams = Map(
      ...
      "anonymousAssessmen@@tLoggedInUserContentIDs" -> "do_1141533540853432321675,do_1141533857591132161321,do_1141525365329264641663,do_1141527106280980481664",
      "anonymousAssessmentNonLoggedInUserAssessmentIDs" -> "do_11415336159226265611",
      cassandraUserExtendedProfileTable
