error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/DashboardUtil.scala:
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/DashboardUtil.scala
...
offset: 36570
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/DashboardUtil.scala
text:
```scala
...
object DashboardConfigParser extends Serializable {
  ...
  def parseConfig(config: Map[String, AnyRef]): DashboardConfig = {
    DashboardConfig(
      ...
      dwUserActivityTable = getConfigModelParam(config, "dwUserActivityTable", "user_activity"),
      ...
      dwContentResourceTable = getConfigModelParam(config, "dwContentResourceTable"),
