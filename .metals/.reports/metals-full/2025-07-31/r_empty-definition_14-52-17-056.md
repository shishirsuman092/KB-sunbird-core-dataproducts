error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/exhaust/DataExhaustModel.scala:`<error>`#`<error>`.
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/exhaust/DataExhaustModel.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/cassandraTableAsDataFrame.
	 -org/apache/spark/sql/cassandraTableAsDataFrame#
	 -org/apache/spark/sql/cassandraTableAsDataFrame().
	 -org/apache/spark/sql/functions/cassandraTableAsDataFrame.
	 -org/apache/spark/sql/functions/cassandraTableAsDataFrame#
	 -org/apache/spark/sql/functions/cassandraTableAsDataFrame().
	 -org/ekstep/analytics/dashboard/DashboardUtil.cassandraTableAsDataFrame.
	 -org/ekstep/analytics/dashboard/DashboardUtil.cassandraTableAsDataFrame#
	 -org/ekstep/analytics/dashboard/DashboardUtil.cassandraTableAsDataFrame().
	 -org/ekstep/analytics/dashboard/DataUtil.cassandraTableAsDataFrame.
	 -org/ekstep/analytics/dashboard/DataUtil.cassandraTableAsDataFrame#
	 -org/ekstep/analytics/dashboard/DataUtil.cassandraTableAsDataFrame().
	 -org/apache/spark/sql/types/cassandraTableAsDataFrame.
	 -org/apache/spark/sql/types/cassandraTableAsDataFrame#
	 -org/apache/spark/sql/types/cassandraTableAsDataFrame().
	 -scala/concurrent/cassandraTableAsDataFrame.
	 -scala/concurrent/cassandraTableAsDataFrame#
	 -scala/concurrent/cassandraTableAsDataFrame().
	 -scala/concurrent/duration/cassandraTableAsDataFrame.
	 -scala/concurrent/duration/cassandraTableAsDataFrame#
	 -scala/concurrent/duration/cassandraTableAsDataFrame().
	 -org/ekstep/analytics/framework/cassandraTableAsDataFrame.
	 -org/ekstep/analytics/framework/cassandraTableAsDataFrame#
	 -org/ekstep/analytics/framework/cassandraTableAsDataFrame().
	 -spark/implicits/cassandraTableAsDataFrame.
	 -spark/implicits/cassandraTableAsDataFrame#
	 -spark/implicits/cassandraTableAsDataFrame().
	 -cassandraTableAsDataFrame.
	 -cassandraTableAsDataFrame#
	 -cassandraTableAsDataFrame().
	 -scala/Predef.cassandraTableAsDataFrame.
	 -scala/Predef.cassandraTableAsDataFrame#
	 -scala/Predef.cassandraTableAsDataFrame().
offset: 15899
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/exhaust/DataExhaustModel.scala
text:
```scala
...
object DataExhaustModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    val userExtendedProfileDF = cassand@@raTableAsDataFrame(conf.cassandraUserKeyspace, conf.cassandraUserExtendedProfileTable)
