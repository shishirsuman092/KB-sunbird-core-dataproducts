error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/enrolment/UserEnrolmentModel.scala:`<error>`#`<error>`.
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/enrolment/UserEnrolmentModel.scala
...
non-local guesses:
	 ...
	 -scala/Predef.userCourseProgramCompletionDataFrame().
offset: 1595
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/enrolment/UserEnrolmentModel.scala
text:
```scala
...
object UserEnrolmentModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    val userEnrolmentDF = userCoursePro@@gramCompletionDataFrame()
    ...
    Redis.closeRedisConnect()
      ...
      case e: Exception =>
        println(s"Error occurred during UserEnrolmentModel processing: ${e.getMessage}", e)
        System.exit(1)
    }
  }
}
