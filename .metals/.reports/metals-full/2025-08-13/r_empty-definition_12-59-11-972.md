error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/course/CourseReportModel.scala:
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/course/CourseReportModel.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/contentWithOrgDetailsDataFrame.
	 -org/apache/spark/sql/functions/contentWithOrgDetailsDataFrame#
	 -org/apache/spark/sql/functions/contentWithOrgDetailsDataFrame().
	 -org/apache/spark/sql/types/contentWithOrgDetailsDataFrame.
	 -org/apache/spark/sql/types/contentWithOrgDetailsDataFrame#
	 -org/apache/spark/sql/types/contentWithOrgDetailsDataFrame().
	 -org/ekstep/analytics/dashboard/DashboardUtil.contentWithOrgDetailsDataFrame.
	 -org/ekstep/analytics/dashboard/DashboardUtil.contentWithOrgDetailsDataFrame#
	 -org/ekstep/analytics/dashboard/DashboardUtil.contentWithOrgDetailsDataFrame().
	 -org/ekstep/analytics/dashboard/DataUtil.contentWithOrgDetailsDataFrame.
	 -org/ekstep/analytics/dashboard/DataUtil.contentWithOrgDetailsDataFrame#
	 -org/ekstep/analytics/dashboard/DataUtil.contentWithOrgDetailsDataFrame().
	 -contentWithOrgDetailsDataFrame.
	 -contentWithOrgDetailsDataFrame#
	 -contentWithOrgDetailsDataFrame().
	 -scala/Predef.contentWithOrgDetailsDataFrame.
	 -scala/Predef.contentWithOrgDetailsDataFrame#
	 -scala/Predef.contentWithOrgDetailsDataFrame().
offset: 945
uri: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/course/CourseReportModel.scala
text:
```scala
...
object CourseReportModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    // Get course data
    val allCourseProgramDetailsDF = broadcast(contentWithOr@@gDetailsDataFrame(orgDF, Seq("Course", "Program", "Blended Program", "CuratedCollections", "Curated Program"))).persist()
