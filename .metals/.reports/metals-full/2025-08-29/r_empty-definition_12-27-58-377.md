error id: file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala:org/ekstep/analytics/dashboard/DataUtil.generateAndSyncReports().
file://<WORKSPACE>/batch-models/src/main/scala/org/ekstep/analytics/dashboard/report/blended/BlendedProgramReportModel.scala
empty definition using pc, found symbol in pc: org/ekstep/analytics/dashboard/DataUtil.generateAndSyncReports().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/generateAndSyncReports.
	 -org/apache/spark/sql/functions/generateAndSyncReports#
	 -org/apache/spark/sql/functions/generateAndSyncReports().
	 -org/ekstep/analytics/dashboard/DashboardUtil.generateAndSyncReports.
	 -org/ekstep/analytics/dashboard/DashboardUtil.generateAndSyncReports#
	 -org/ekstep/analytics/dashboard/DashboardUtil.generateAndSyncReports().
	 -org/ekstep/analytics/dashboard/DataUtil.generateAndSyncReports.
	 -org/ekstep/analytics/dashboard/DataUtil.generateAndSyncReports#
	 -org/ekstep/analytics/dashboard/DataUtil.generateAndSyncReports().
	 -org/apache/spark/sql/types/generateAndSyncReports.
	 -org/apache/spark/sql/types/generateAndSyncReports#
	 -org/apache/spark/sql/types/generateAndSyncReports().
	 -generateAndSyncReports.
	 -generateAndSyncReports#
	 -generateAndSyncReports().
	 -scala/Predef.generateAndSyncReports.
	 -scala/Predef.generateAndSyncReports#
	 -scala/Predef.generateAndSyncReports().
offset: 20113
...
object BlendedProgramReportModel extends AbsDashboardModel {
  ...
  def processData(timestamp: Long)(implicit spark: SparkSession, sc: SparkContext, fc: FrameworkContext, conf: DashboardConfig): Unit = {
    ...
    generateAndSync@@Reports(cbpReportDF.filter(col("status").cast("int") === 1).select(columnsToKeepInCBPReport.map(col): _*), "mdoid", reportPathCBP, "BlendedProgramReport")
